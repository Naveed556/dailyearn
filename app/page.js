          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                ...
                /> */}
                <Image className="shadow-lg rounded-full max-w-full mx-auto" src={moazzam} width={120} alt="Nawab Moazzam" />
                <div className="pt-6 text-center">
                  ...
                  <div className="mt-3 flex items-center justify-center gap-4">
                    <Link href={"https://www.facebook.com/nawab.webdev/"} target="blank" className="w-8 h-8 m-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="hover:text-blue-600 transition-all duration-500" viewBox="0 0 16 16">
                    ...
                    <Link href={"https://www.instagram.com/nawab_webdev/"} target="blank" className="w-8 h-8 m-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="hover:text-pink-600 transition-all duration-500" viewBox="0 0 16 16">
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                {/* <img
                  ...
                  style={{ maxWidth: "120px" }}
                /> */}
                <Image className="shadow-lg rounded-full max-w-full mx-auto" src={nabeel} width={120} alt="Nabeel Ameen" />
                <div className="pt-6 text-center">
                  <h5 className="text-white text-xl font-bold">
                    Nabeel Ameen
                  </h5>
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                {/* <img
                  ...
                  style={{ maxWidth: "120px" }}
                /> */}
                <Image className="shadow-lg rounded-full max-w-full mx-auto" src={aftab} width={120} alt="Aftab Ahmad" />
                <div className="pt-6 text-center">
                  <h5 className="text-white text-xl font-bold">
                    Aftab Ahmad
                  </h5>
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                {/* <img
                  ...
                  style={{ maxWidth: "120px" }}
                /> */}
                <Image className="shadow-lg rounded-full max-w-full mx-auto" src={naveed} width={120} alt="Naveed Ameen" />
                <div className="pt-6 text-center">
                  <h5 className="text-white text-xl font-bold">
                    Naveed Ameen
                  </h5>
