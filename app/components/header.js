    ...
    return (
        <header className="text-gray-400 bg-gray-900 body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <Link href={"http://localhost:3000/"} className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
                ...
                {(currentPath == "/login" || currentPath == "/") &&
                    <Link href={"/login"} className='md:ml-auto flex flex-wrap items-center justify-center'>
                        <button className="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0">Go to Dashboard
                            <lord-icon
                ...
                {!(currentPath == "/login" || currentPath == "/") &&
                    <>
                        ...
                        <button onClick={() => { handleLogout() }} className="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0">Log Out
                            <lord-icon
                                src="https://cdn.lordicon.com/vduvxizq.json"
                                trigger="hover"
                                colors="primary:#9ca3af"
