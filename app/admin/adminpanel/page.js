            ...
            <main className="relative">
                ...
                <div className="w-[80vw] mx-auto mt-4 relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div className="bg-white dark:bg-gray-900 flex justify-between items-center flex-wrap gap-2 p-1">
                        ...
                        <div tabIndex="-1" aria-hidden="true" className={`bg-[#37415180] ${hideAddUser ? "hidden" : "flex"} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-screen max-h-full`}>
